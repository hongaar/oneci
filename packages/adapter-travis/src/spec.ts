// http://json.schemastore.org/travis & https://transform.now.sh/json-schema-to-ts/
...
export type StringOrNumberOrAcceptBothTypeAsArrayUnique =
  | StringOrNumber
